...
int main() {
  ...
  cgmres::ZeroHorizonOCPSolver<cgmres::OCP_tairetu, kmax_init> initializer(ocp, settings);
  cgmres::Vector<6> uc0;
  uc0 << 0.001, 0.001, 0.001, 0.001, 0.001, 0.001;
  ...
  cgmres::SingleShootingCGMRESSolver<cgmres::OCP_tairetu, N, kmax> mpc(ocp, horizon, settings);
  ...
  const std::string log_name("../log/tairetu"); 
