...
#ifndef CGMRES__OCP_TAIRETU_HPP_ 
#define CGMRES__OCP_TAIRETU_HPP_ 
...
/// 
/// @class OCP_tairetu
/// @brief Definition of the optimal control problem (OCP) of tairetu.
/// 
class OCP_tairetu { 
public:
  ///
  ...
  friend std::ostream& operator<<(std::ostream& os, const OCP_tairetu& ocp) { 
    ocp.disp(os);
    return os;
  }
  ...
  void eval_phix(const double t, const double* x, double* phix) const {
    ...
    phix[7] = 0;
    phix[8] = 0;
    phix[9] = sf21*(2*x[0] - 2*x[3]);
    phix[10] = 2*sf22*(-D + sqrt(pow(-x[1] + x[4], 2)))*(x[1] - x[4])*sqrt(pow(-x[1] + x[4], 2))/pow(-x[1] + x[4], 2);
    phix[11] = 0;
    phix[12] = sf21*(-2*x[0] + 2*x[3]);
    phix[13] = 2*sf22*(-D + sqrt(pow(-x[1] + x[4], 2)))*sqrt(pow(-x[1] + x[4], 2))/(-x[1] + x[4]);
    phix[14] = 0;
    phix[15] = 0;
    phix[16] = 0;
    phix[17] = 0;
    ...
    phix[19] = 0;
    phix[20] = 0;
    phix[21] = sf31*(2*x[3] - 2*x[6]);
    phix[22] = 2*sf32*(-D + sqrt(pow(-x[4] + x[7], 2)))*(x[4] - x[7])*sqrt(pow(-x[4] + x[7], 2))/pow(-x[4] + x[7], 2);
    phix[23] = 0;
    phix[24] = sf31*(-2*x[3] + 2*x[6]);
    phix[25] = 2*sf32*(-D + sqrt(pow(-x[4] + x[7], 2)))*sqrt(pow(-x[4] + x[7], 2))/(-x[4] + x[7]);
    phix[26] = 0;
  ...
  void eval_hx(const double t, const double* x, const double* u, 
    ...
    hx[9] = q21*(2*x[0] - 2*x[3]);
    hx[10] = 2*q22*(-D + sqrt(pow(-x[1] + x[4], 2)))*(x[1] - x[4])*sqrt(pow(-x[1] + x[4], 2))/pow(-x[1] + x[4], 2);
    hx[11] = lmd[10]*u[0]*cos(x[2]) - lmd[9]*u[0]*sin(x[2]);
    hx[12] = q21*(-2*x[0] + 2*x[3]);
    hx[13] = 2*q22*(-D + sqrt(pow(-x[1] + x[4], 2)))*sqrt(pow(-x[1] + x[4], 2))/(-x[1] + x[4]);
    ...
    hx[21] = q31*(2*x[3] - 2*x[6]);
    hx[22] = 2*q32*(-D + sqrt(pow(-x[4] + x[7], 2)))*(x[4] - x[7])*sqrt(pow(-x[4] + x[7], 2))/pow(-x[4] + x[7], 2);
    hx[23] = -lmd[21]*u[2]*sin(x[5]) + lmd[22]*u[2]*cos(x[5]);
    hx[24] = q31*(-2*x[3] + 2*x[6]);
    hx[25] = 2*q32*(-D + sqrt(pow(-x[4] + x[7], 2)))*sqrt(pow(-x[4] + x[7], 2))/(-x[4] + x[7]);
  ...
  void eval_hu(const double t, const double* x, const double* u, 
    ...
    hu[2] = lmd[12]*cos(x[5]) + lmd[13]*sin(x[5]) + r21*(-2*u[0] + 2*u[2]) + lmd[14]*tan(u[3])/Length;
    hu[3] = 2*r22*u[3] + lmd[14]*u[2]*(pow(tan(u[3]), 2) + 1)/Length;
    hu[4] = lmd[24]*cos(x[8]) + lmd[25]*sin(x[8]) + r31*(-2*u[2] + 2*u[4]) + lmd[26]*tan(u[5])/Length;
    hu[5] = 2*r32*u[5] + lmd[26]*u[4]*(pow(tan(u[5]), 2) + 1)/Length;
